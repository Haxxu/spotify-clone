...
const usefullLinks = ['Support', 'Web Player', 'Free Mobile App'];
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main_container}>
                <div className={styles.main}>
                    ...
                    <p>Milions of songs and podcasts. No credit card needed.</p>
                    <Link to='/signup'>
                        <Button
                            label='GET SPOTIFY FREE'
                            style={{ color: 'var(--blue)', width: '18rem', fontSize: '1.4rem' }}
                        />
                    </Link>
                </div>
            </main>
