...
import { deletePlaylist, removeSongFromPlaylist } from '~/redux/playlistSlice/apiCall';
                    ...
                    <div className={styles.body}>
                        ...
                        {songs.map((song) => (
                            <Fragment key={song._id}>
                                <Song song={song} playlist={playlist} handleRemoveSong={handleRemoveSong} />
                            </Fragment>
                        ))}
                    </div>
                    {model && <PlaylistModel closeModel={() => setModel(false)} playlist={playlist} />}
                </>
            )}
        </div>
    );
